$(function() {
    ...
    $("#btn_upload_course_img").change(function() {
        uploadImg($(this), $("#course_img_path"), $("#courseImg"));
    });

    $("#btn_upload_member_photo").change(function() {
        uploadImg($(this), $("#member_photo_path"), $("#memberPhoto"));
    });
            ...
            swal({
                ...
                if(result.value) {
                    $.ajax({
                        ...
                        dataType: "json",
                        data: {"courseID": courseID.attr("courseID")},
                        success: function(response) {
            ...
            swal({
                ...
                if(result.value) {
                    $.ajax({
                        ...
                        dataType: "json",
                        data: {"memberID": memberID.attr("memberID")},
                        success: function(response) {
                            swal("Sucesso!", "Ação executada com sucesso!", "success");
                            dt_member.ajax.reload();
                        }
    ...
    var dt_course = $("#dt_courses").DataTable({
        ...
        "columnDefs": [
            ...
            { targets: "dt-center", class: "dt-center"},
        ],
